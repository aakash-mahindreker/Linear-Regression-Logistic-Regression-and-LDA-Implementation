...
X_train_temp = X_train[['petal length (cm)', 'petal width (cm)', 'sepal length (cm)', 'sepal width (cm)']]
X_val_temp = X_val[['petal length (cm)', 'petal width (cm)', 'sepal length (cm)', 'sepal width (cm)']]
...
acc = model.accuracy_score(y_pred,y_val_encoded)
print("Accuracy: ",acc)
